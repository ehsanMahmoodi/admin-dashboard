...
export const useStyle = makeStyles({
    loginUserForm: {
        ...
        "& svg": {
            margin: '0 0.62rem 0 0.31rem', width: '1.25rem', height: '1.25rem', color: '#6B7280', "&:nth-child(1)": {
                cursor: 'pointer'
            }
        }
    }, siteRulls: {
        display: 'flex', "& > a": {
            marginLeft: '0.3rem', fontSize: "0.87rem", color: "#3B82F6", fontWeight: "100 !important"
        }
    }, inputCheckbox: {
        ...
        outline: 'none',
        "& svg": {
            color: '#fff', marginRight: "0.43rem", width: '1.25rem', height: '1.25rem', marginTop: '-0.18rem'
        },
